export const SLOTS = [
  ...
  { id: "color_before",        label: "Color Grading - before",     width: 1920, height: 1080, notes: "Before image for the cinematic color grading sliders. Match sort order with color_after." },
  { id: "color_after",         label: "Color Grading - after",      width: 1920, height: 1080, notes: "After/graded image for the cinematic color grading sliders. Match sort order with color_before." },
...
export const VIDEO_SLOTS = [
  ...
  { id: "color_grading_video", label: "Color Grading video",       notes: "Cinematic video placed between before/after slider sets in the Color Grading section." },
